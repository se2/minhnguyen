	...
	<div class="post-featured py-30 bg-cover bg-center bg-no-repeat w-full mb-40 lg:mb-80 flex flex-wrap justify-center items-center" style="background-image:url(<?php echo esc_url( $featured ); ?>);">
		<div class="w-auto post-header text-center relative z-50 px-20">
			<a href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>" class="back-to-blog flex flex-wrap items-center text-white uppercase	text-12px leading-lg justify-center">
				<i class="fas fa-arrow-left mr-10 fa-lg"></i>
...
<div class="post-navigation w-full overflow-auto flex flex-wrap">
	...
	?>
	<div class="post-prev dark-overlay w-full lg:flex-1 bg-cover bg-center bg-no-repeat flex flex-wrap items-center justify-center" style="background-image:url(<?php echo esc_url( $thumbnail ); ?>);">
		<div class="w-full xl:w-5/6 px-20 xl:px-0 relative z-50">
			<a href="<?php echo esc_url( $prev_post_link_url ); ?>" title="<?php echo esc_html( $prev_post->post_title ); ?>" class="back-to-blog">
				<div class="flex flex-wrap items-center text-white uppercase text-12px leading-lg justify-center">
					<i class="fas fa-arrow-left mr-10 fa-lg"></i>
					<span>Bài Trước</span>
				</div>
				<div class="block no-underline uppercase tracking-wide text-white font-bold text-xl leading-lg w-full text-center">
	...
	?>
	<div class="post-next dark-overlay w-full lg:flex-1 bg-cover bg-center bg-no-repeat flex flex-wrap items-center justify-center" style="background-image:url(<?php echo esc_url( $thumbnail ); ?>);">
		<div class="w-full xl:w-5/6 px-20 xl:px-0 relative z-50">
			<a href="<?php echo esc_url( $next_post_link_url ); ?>" title="<?php echo esc_html( $next_post->post_title ); ?>" class="back-to-blog">
				<div class="flex flex-wrap items-center text-white uppercase text-12px leading-lg justify-center">
					<span>Bài Tiếp Theo</span>
					<i class="fas fa-arrow-right ml-10 fa-lg"></i>
				</div>
				<div class="block no-underline uppercase tracking-wide text-white font-bold text-xl leading-lg w-full text-center">
